...
//<<<<<<< HEAD
        var todayWeatherImageView:ImageView = findViewById(R.id.show_weather_picture_imageView)
        ...
        toWeatherPictureId[catchWeatherData()]?.let { todayWeatherImageView.setImageResource(it) }
    ...
    private fun catchWeatherData(): String {
        ...
        object : Thread() {
            override fun run() {
                ...
                var line: String = InputStreamReader(connection.inputStream).readText()
